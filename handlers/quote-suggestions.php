...
// i shall have a hidden button, that pops up when logged in under my account, where it auto accepts the quote
// this quote shall then be added to the list and deleted from the queue